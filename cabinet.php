                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col l12">
                            <p>
                                <label>
                                    <input class="gender" name="group1" type="radio" value="male" checked />
                                    <span>Male</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input class="gender" name="group1" type="radio" value="female" />
                                    <span>Female</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input class="gender with-gap" name="group1" type="radio" value="other" />
                                    <span>Other</span>
                                </label>
                            </p>
                        </div>
